...
function initCounters() {
  ...
  if (!el) return;
  const wrap = el.closest('.hero-strip') || el.closest('.story-stats') || el.parentElement;
...
function pesanMenu(nama) { showToast(`🍃 ${nama} ditambahkan ke pesanan`); }
